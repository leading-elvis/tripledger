...
export type Expense = { id: string; title: string; amount: number; payerId: string; shares: {memberId:string;amount:number}[]; date: string; category: string; voided: boolean; splitMode?: 'equal'|'exact'; receipt?: Receipt; createdBy:string|null };
