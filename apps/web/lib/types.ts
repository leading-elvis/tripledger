...
export type HistoryEntry = {id:string;at:string;targetId:string;actorId:string|null} & ({action:'edit-expense'|'void-expense';before:ExpenseSnapshot;after:ExpenseSnapshot}|{action:'rename-trip'|'rename-member';before:string;after:string}|{action:'set-archived';before:boolean;after:boolean});
